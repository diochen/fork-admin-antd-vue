            ...
            <a-form :labelCol="{ span: 3, offset: 0 }" :wrapper-col="{span:21}">
                <a-row :gutter="16" justify="end">
                    <a-col :xs="24" :sm="24" :md="24" :lg="6" :xl="6">
                        <a-form-item  label="名稱：" v-bind="searchValidateInfos.name">
                            <a-input placeholder="請輸入" v-model:value="searchModelRef.name" />
                        </a-form-item>
                    </a-col>
                    <a-col :xs="24" :sm="24" :md="24" :lg="6" :xl="6">
                        <a-form-item  label="鏈接：" v-bind="searchValidateInfos.href">
                            <a-input placeholder="請輸入" v-model:value="searchModelRef.href" />
                        </a-form-item>
                    </a-col>
                    <a-col :xs="24" :sm="24" :md="24" :lg="6" :xl="6">
                        <a-form-item  label="位置：" v-bind="searchValidateInfos.type">
                            <TypeSelect placeholder="請選擇" v-model:value="searchModelRef.type" />
                        </a-form-item>
                    </a-col>
                    <a-col v-if='searchOpen' :xs="24" :sm="24" :md="24" :lg="6" :xl="6">
                        <a-form-item label="備註：" v-bind="searchValidateInfos.desc">
                            <a-input placeholder="請輸入" v-model:value="searchModelRef.desc" />
                        </a-form-item>
                    </a-col>
                    <a-col :xs="24" :sm="24" :md="24" :lg="6" :xl="6">
                        <div class="text-align-right" style="padding-bottom: 24px" >
                            <a-button type="primary" @click="searchFormSubmit">查詢</a-button>
        ...
        <a-card :bordered="false">
            ...
            <template #extra>
                    <a-radio-group defaultValue="all">
                        ...
                        <a-radio-button value="header">頭部</a-radio-button>
                        <a-radio-button value="footer">底部</a-radio-button>
                    </a-radio-group>
                    <a-input-search placeholder="請輸入"  style="width:270px;margin-left: 16px;" />
            </template>
