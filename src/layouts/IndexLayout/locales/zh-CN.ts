export default {
  ...
  'index-layout.menu.home.custom-breadcrumbs': '自定義麵包屑',
  ...
  'index-layout.menu.component.icon': '圖示',
  ...
  'index-layout.menu.pages': '頁麵示例',
  'index-layout.menu.pages.list': '列錶頁麵',
  'index-layout.menu.pages.list.basic': '標準列錶',
  'index-layout.menu.pages.list.table': '錶格列錶',
  'index-layout.menu.pages.list.highly-adaptive-table': '高度自適應錶格',
  'index-layout.menu.pages.list.search': '搜索列錶',
  'index-layout.menu.pages.list.search.table': '查詢錶格',
  'index-layout.menu.pages.form': '錶單頁麵',
  'index-layout.menu.pages.form.basic': '基礎錶單',
  'index-layout.menu.pages.form.complex': '高級錶單',
  'index-layout.menu.pages.detail': '詳情頁麵',
  'index-layout.menu.pages.detail.basic': '基礎詳情',
  'index-layout.menu.pages.detail.module': '模塊詳情',
  'index-layout.menu.pages.detail.table': '錶格詳情',
